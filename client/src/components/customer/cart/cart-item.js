...
export const CartItem = ({ item }) => {
  const { images, name, price, sale, originalPrice, discountType, discount } = item.product;
  ...
  return (
    <div className="cart-item d-flex py-3">
      ...
      <div className="d-flex ml-3 flex-column justify-content-center w-100">
        ...
        >
          <Price currency="€" price={price * quantity} sale={sale} originalPrice={originalPrice * quantity} discount={discount} discountType={discountType} />
