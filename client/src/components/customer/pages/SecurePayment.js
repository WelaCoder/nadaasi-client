...
const SecurePayment = () => {
  ...
  return (
    <div>
      ...
      <section style={{ marginTop: '50px' }} id="wrapper">
          ...
          <div id="#content-wrapper">
            ...
            <section id="main">
              ...
              <section id="#content" class="page-content page-cms page-cms-5">
                <p>We use klarna as our online payment method that allows us to give customers a
                ...
                <p></p>
                <h2>Pay Now</h2>
                <p>Pay now allows customers to pay at the time of the purchase. The service
                ...
                <p></p>
                <h2>Pay Later</h2>
                <p>Pay later offers interest-free deferred payments for customers who want to
                ...
                <p></p>
                <h2>Slice It</h2>
                <p>Slice it is a payment method which offers consumers to finance their
