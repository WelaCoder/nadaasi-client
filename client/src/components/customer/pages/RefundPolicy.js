    ...
    <div className="container">
      <section id="main">
        ...
        <section style={{ marginTop: "50px", marginBottom: "100px", }} id="" class="page-content page-cms page-cms-8 my-font-futura">
          ...
          <p className='my-font-futura'>You have a 14-day right to return or exchange a product according to Finnish
            consumer protection legislation. You have the right to return the order if:</p>
          <ol style={{ marginLeft: '50px' }}>
            <li className='my-font-futura'>The order has been cancelled according to the Terms &amp; Conditions by
            ...
            <li className='my-font-futura'>The item has been repackaged into its original package or an equivalent</li>
          </ol>
          <p className='my-font-futura'>The product must be returned immediately after cancellation. When returning
          ...
          <p className='my-font-futura'>After we have received the returned item(s) and all the criteria (1-4) listed
          ...
          payment method you have selected. This can vary greatly between different
            payment methods.</p>
          <p className='my-font-futura'>Before sending any returns, please contact us by email: info@nadaasi.fi</p>
        </section>
      </section>
    </div>
  )
